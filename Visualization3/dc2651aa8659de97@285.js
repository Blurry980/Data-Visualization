...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([["countries-50m.json",new URL("./files/105124169f32536c2c86c7d6a237673814f21444a667f2cb8c4e2b3f7b3cfae56fac5346a6ac7fd5cc02b63fcda1b08ac4e86a7c86896e5eeb37b51ccceb8f69",import.meta.url)],["hale2020.csv",new URL("./files/C0F2665702539EC9EC71434E8D87FE7C285F5D6489AAE0B8E0CC1E8C271DAF32",import.meta.url)]]);
  main.builtin("FileAttachment", runtime.fileAttachments(name => fileAttachments.get(name)));
  main.variable(observer()).define(["md"], function(md){return(
md`# World Choropleth

Health-adjusted life expectancy, 2020. Data: [WHO](https://www.who.int/data/gho/data/indicators/indicator-details/GHO/gho-ghe-hale-healthy-life-expectancy-at-birth)`
)});
...
Object.assign(new Map(d3.csvParse(await FileAttachment("hale2020.csv").text(), ({country, hale}) => [rename.get(country) || country, +hale])), {title: "Healthy life expectancy (years)"})
)});
